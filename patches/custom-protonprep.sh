...
git commit -a "Revert problematic commit df43fd7"
popd
...
echo "WINE: -XIVLauncher.Core- Add Wine-to-Unix PID mapping"
patch -Np1 < ../paches/custom/proton8-unix-pid-maps.patch
