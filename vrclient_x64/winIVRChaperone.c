...
uint32_t __thiscall winIVRChaperone_IVRChaperone_002_GetCalibrationState(struct w_iface *_this)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_002_GetSoftBoundsInfo(struct w_iface *_this, ChaperoneSoftBoundsInfo_t *pInfo)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_002_GetSeatedBoundsInfo(struct w_iface *_this, ChaperoneSeatedBoundsInfo_t *pInfo)
{
...
void __thiscall winIVRChaperone_IVRChaperone_002_ReloadInfo(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_002_SetSceneColor(struct w_iface *_this, HmdColor_t color)
{
...
void __thiscall winIVRChaperone_IVRChaperone_002_GetBoundsColor(struct w_iface *_this, HmdColor_t *pOutputColorArray, int32_t nNumOutputColors)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_002_AreBoundsVisible(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_002_ForceBoundsVisible(struct w_iface *_this, int8_t bForce)
{
...
void destroy_winIVRChaperone_IVRChaperone_002(struct w_iface *object)
{
    TRACE("%p\n", object);
...
void destroy_winIVRChaperone_IVRChaperone_002_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
...
uint32_t __thiscall winIVRChaperone_IVRChaperone_003_GetCalibrationState(struct w_iface *_this)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_003_GetPlayAreaSize(struct w_iface *_this, float *pSizeX, float *pSizeZ)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_003_GetPlayAreaRect(struct w_iface *_this, HmdQuad_t *rect)
{
...
void __thiscall winIVRChaperone_IVRChaperone_003_ReloadInfo(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_003_SetSceneColor(struct w_iface *_this, HmdColor_t color)
{
...
void __thiscall winIVRChaperone_IVRChaperone_003_GetBoundsColor(struct w_iface *_this, HmdColor_t *pOutputColorArray, int32_t nNumOutputColors, float flCollisionBoundsFadeDistance, HmdColor_t *pOutputCameraColor)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_003_AreBoundsVisible(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_003_ForceBoundsVisible(struct w_iface *_this, int8_t bForce)
{
...
void destroy_winIVRChaperone_IVRChaperone_003(struct w_iface *object)
{
    TRACE("%p\n", object);
    HeapFree(GetProcessHeap(), 0, object);
}
...
void destroy_winIVRChaperone_IVRChaperone_003_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
    VirtualFree(object->vtable[0], 0, MEM_RELEASE);
    HeapFree(GetProcessHeap(), 0, object->vtable);
...
uint32_t __thiscall winIVRChaperone_IVRChaperone_004_GetCalibrationState(struct w_iface *_this)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_004_GetPlayAreaSize(struct w_iface *_this, float *pSizeX, float *pSizeZ)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_004_GetPlayAreaRect(struct w_iface *_this, HmdQuad_t *rect)
{
...
void __thiscall winIVRChaperone_IVRChaperone_004_ReloadInfo(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_004_SetSceneColor(struct w_iface *_this, HmdColor_t color)
{
...
void __thiscall winIVRChaperone_IVRChaperone_004_GetBoundsColor(struct w_iface *_this, HmdColor_t *pOutputColorArray, int32_t nNumOutputColors, float flCollisionBoundsFadeDistance, HmdColor_t *pOutputCameraColor)
{
...
int8_t __thiscall winIVRChaperone_IVRChaperone_004_AreBoundsVisible(struct w_iface *_this)
{
...
void __thiscall winIVRChaperone_IVRChaperone_004_ForceBoundsVisible(struct w_iface *_this, int8_t bForce)
{
...
void __thiscall winIVRChaperone_IVRChaperone_004_ResetZeroPose(struct w_iface *_this, uint32_t eTrackingUniverseOrigin)
{
...
void destroy_winIVRChaperone_IVRChaperone_004(struct w_iface *object)
{
    TRACE("%p\n", object);
    HeapFree(GetProcessHeap(), 0, object);
}
...
void destroy_winIVRChaperone_IVRChaperone_004_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
    VirtualFree(object->vtable[0], 0, MEM_RELEASE);
    HeapFree(GetProcessHeap(), 0, object->vtable);
