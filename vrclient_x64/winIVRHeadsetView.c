...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_SetHeadsetViewSize(struct w_iface *_this, uint32_t nWidth, uint32_t nHeight)
{
...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_GetHeadsetViewSize(struct w_iface *_this, uint32_t *pnWidth, uint32_t *pnHeight)
{
...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_SetHeadsetViewMode(struct w_iface *_this, uint32_t eHeadsetViewMode)
{
...
uint32_t __thiscall winIVRHeadsetView_IVRHeadsetView_001_GetHeadsetViewMode(struct w_iface *_this)
{
...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_SetHeadsetViewCropped(struct w_iface *_this, int8_t bCropped)
{
...
int8_t __thiscall winIVRHeadsetView_IVRHeadsetView_001_GetHeadsetViewCropped(struct w_iface *_this)
{
...
float __thiscall winIVRHeadsetView_IVRHeadsetView_001_GetHeadsetViewAspectRatio(struct w_iface *_this)
{
...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_SetHeadsetViewBlendRange(struct w_iface *_this, float flStartPct, float flEndPct)
{
...
void __thiscall winIVRHeadsetView_IVRHeadsetView_001_GetHeadsetViewBlendRange(struct w_iface *_this, float *pStartPct, float *pEndPct)
{
...
void destroy_winIVRHeadsetView_IVRHeadsetView_001(struct w_iface *object)
{
    TRACE("%p\n", object);
...
void destroy_winIVRHeadsetView_IVRHeadsetView_001_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
