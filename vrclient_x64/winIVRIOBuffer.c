...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_001_Open(struct w_iface *_this, const char *pchPath, uint32_t mode, uint32_t unElementSize, uint32_t unElements, uint64_t *pulBuffer)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_001_Close(struct w_iface *_this, uint64_t ulBuffer)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_001_Read(struct w_iface *_this, uint64_t ulBuffer, void *pDst, uint32_t unBytes, uint32_t *punRead)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_001_Write(struct w_iface *_this, uint64_t ulBuffer, void *pSrc, uint32_t unBytes)
{
...
uint64_t __thiscall winIVRIOBuffer_IVRIOBuffer_001_PropertyContainer(struct w_iface *_this, uint64_t ulBuffer)
{
...
void destroy_winIVRIOBuffer_IVRIOBuffer_001(struct w_iface *object)
{
    TRACE("%p\n", object);
...
void destroy_winIVRIOBuffer_IVRIOBuffer_001_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_Open(struct w_iface *_this, const char *pchPath, uint32_t mode, uint32_t unElementSize, uint32_t unElements, uint64_t *pulBuffer)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_Close(struct w_iface *_this, uint64_t ulBuffer)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_Read(struct w_iface *_this, uint64_t ulBuffer, void *pDst, uint32_t unBytes, uint32_t *punRead)
{
...
uint32_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_Write(struct w_iface *_this, uint64_t ulBuffer, void *pSrc, uint32_t unBytes)
{
...
uint64_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_PropertyContainer(struct w_iface *_this, uint64_t ulBuffer)
{
...
int8_t __thiscall winIVRIOBuffer_IVRIOBuffer_002_HasReaders(struct w_iface *_this, uint64_t ulBuffer)
{
...
void destroy_winIVRIOBuffer_IVRIOBuffer_002(struct w_iface *object)
{
    TRACE("%p\n", object);
    HeapFree(GetProcessHeap(), 0, object);
}
...
void destroy_winIVRIOBuffer_IVRIOBuffer_002_FnTable(struct w_iface *object)
{
    TRACE("%p\n", object);
    VirtualFree(object->vtable[0], 0, MEM_RELEASE);
    HeapFree(GetProcessHeap(), 0, object->vtable);
