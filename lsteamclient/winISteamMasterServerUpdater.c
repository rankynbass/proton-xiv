...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_SetActive(struct w_iface *_this, int8_t bActive)
{
...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_SetHeartbeatInterval(struct w_iface *_this, int32_t iHeartbeatInterval)
{
...
int8_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_HandleIncomingPacket(struct w_iface *_this, const void *pData, int32_t cbData, uint32_t srcIP, uint16_t srcPort)
{
...
int32_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_GetNextOutgoingPacket(struct w_iface *_this, void *pOut, int32_t cbMaxOut, uint32_t *pNetAdr, uint16_t *pPort)
{
...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_ClearAllKeyValues(struct w_iface *_this)
{
...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_SetKeyValue(struct w_iface *_this, const char *pKey, const char *pValue)
{
...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_NotifyShutdown(struct w_iface *_this)
{
...
int8_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_WasRestartRequested(struct w_iface *_this)
{
...
void __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_ForceHeartbeat(struct w_iface *_this)
{
...
int8_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_AddMasterServer(struct w_iface *_this, const char *pServerAddress)
{
...
int8_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_RemoveMasterServer(struct w_iface *_this, const char *pServerAddress)
{
...
int32_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_GetNumMasterServers(struct w_iface *_this)
{
...
int32_t __thiscall winISteamMasterServerUpdater_SteamMasterServerUpdater001_GetMasterServerAddress(struct w_iface *_this, int32_t iServer, char *pOut, int32_t outBufferSize)
{
